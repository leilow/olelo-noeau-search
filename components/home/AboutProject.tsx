    ...
    <section className="bg-white/60 backdrop-blur-sm p-8 rounded-lg shadow-sm" style={{ backgroundColor: 'rgba(182, 226, 221, 0.7)' }}>
      ...
      <div className="font-body space-y-5 text-text/85 leading-relaxed" style={{ color: '#3d3424' }}>
        {/* <p className="text-lg"> */}
          ...
          <p>The original content was published on <strong><a href="https://trussel2.com" target="_blank">trussell.com</a></strong>. The creator is fully credited; please continue to give proper acknowledgment. To support the preservation of Hawaiian culture, we recommend purchasing the book from <strong><a href="https://bishopmuseumpress.org/products/olelo-no-eau-hawaiian-proverbs-poetical-sayings-1?_pos=1&_sid=c5910c547&_ss=r" target="_blank">Bishop Museum Press</a></strong>.</p>
      </div>
    </section>
  );
}
